/**
 * Created by chengfubei on 2016/8/17.
 */
...
function btn_move(el,mouseLeft,mouseTop){
    ...
    var btnLeft = mouseLeft+(leftRnd>0?140:-140)+leftRnd;
    var btnTop = mouseTop+(leftRnd>0?50:-50)+topRnd;
    ...
    console.log(el.style.left) //position
    console.log(el.style.top) //position
}
function over_btn(e){
    if(!e){
        e = window.event;
